        ...
        contains: [
            ...
            },
            {
                ...
                begin: new RegExp(
                    ...
                    'find_index|index_of|count|sum|min|max|flat|map|map_id|map_wrap|map_type|vmap|name|owner|set_owner|pop|push|fill|remove|replace|reverse|restrict|restriction|split|sort|splice|unique|is_unique|' +
